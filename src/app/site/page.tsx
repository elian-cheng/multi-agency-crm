...
export default async function Home() {
  const prices = await stripe?.prices?.list({
    product: process.env.NEXT_SYNTRO_PRODUCT_ID,
    active: true
  });
    ...
    <>
      <section className="h-full w-full md:pt-44 mt-[-40px] relative flex items-center justify-center flex-col ">
        ...
        <div className="bg-gradient-to-r from-primary to-secondary-foreground text-transparent bg-clip-text relative">
          <h1 className="text-8xl font-bold text-center sm:text-5xl md:text-[220px] lg:text-[300px]">
            Syntro
          </h1>
        </div>
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 lg:!mt-40 mt-[-80px]">
        ...
        <div className="flex  justify-center gap-4 flex-wrap mt-6 mb-14">
