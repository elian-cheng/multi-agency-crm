    ...
    if (type === "agency") {
      await saveActivityLogsNotification({
        ...
        description: `Gave ${userData?.name} access to | ${
          subAccountPermissions?.Permissions.find(p => p.subAccountId === subAccountId)?.SubAccount
            .name
        } `,
        subaccountId: subAccountPermissions?.Permissions.find(p => p.subAccountId === subAccountId)
          ?.SubAccount.id
      });
    }
